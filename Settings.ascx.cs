...
namespace GIBS.Modules.GIBS_QR_Code
{
    ...
    /// 
    /// Because the control inherits from GIBS_QR_CodeSettingsBase you have access to any custom properties
    /// defined there, as well as properties from DNN such as PortalId, ModuleId, TabId, UserId and many more.
    /// </summary>
    /// -----------------------------------------------------------------------------
    public partial class Settings : GIBS_QR_CodeModuleSettingsBase
    {
        ...
        public override void LoadSettings()
        {
            try
            {
                if (Page.IsPostBack == false)
                {
                    ...
                    ddlQRType.SelectedValue = DefaultQRType.ToString();
        ...
        public override void UpdateSettings()
        {
            try
            {
                ...
                DefaultQRType = ddlQRType.SelectedValue.ToString();
            }
            catch (Exception exc) //Module failed to load
            {
                Exceptions.ProcessModuleLoadException(this, exc);
